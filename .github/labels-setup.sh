...
create director-approved C2E0C6 "Director approved — ready for architecture (orchestrator trigger)"
create approved C2E0C6 "Legacy alias — converted to director-approved by Director gate"
